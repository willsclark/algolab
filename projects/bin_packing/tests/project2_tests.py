...
def test_algorithm(
    ...
    algorithm: Callable[[list[float], list[int], list[float]], None],
    name: str,
):
...
def zip_tree_tests():
    ...
    data = [
        InsertType(4, "a", requirements.Rank(0, 9)),
    ...
    tree.remove(5)
    tree.remove(4)
    print(f"Deleted all: get_size(): {tree.get_size()}, Expected: 0")

    data2 = [
        InsertType(4, "a", requirements.Rank(2, 1)),
        InsertType(5, "b", requirements.Rank(2, 2)),
        InsertType(2, "c", requirements.Rank(1, 8)),
        InsertType(1, "d", requirements.Rank(0, 12)),
        InsertType(0, "e", requirements.Rank(1, 8)),
    ]
...
def bin_packing_tests():
    ...
    expected_result = ProblemInstance(
        items=items,
        assignments=[0, 0, 1, 1, 2, 1, 3, 3],
        free_space=[0.1, 0.0, 0.3, 0.0],
    )
    ...
    expected_result = ProblemInstance(
        items=items,
        assignments=[0, 1, 2, 3, 2, 1, 0, 3],
        free_space=[0.0, 0.0, 0.0, 0.4],
    )
    test_algorithm(
        test1,
        expected_result,
        requirements.first_fit_decreasing,
    ...
    test_algorithm(
        test1, expected_result, requirements.best_fit_decreasing, "best_fit_decreasing"
    )
    ...
    expected_result = ProblemInstance(
        items=items,
        assignments=[0, 1, 2, 3, 3, 3, 4, 5, 5, 6, 6, 6],
        free_space=[0.21, 0.12, 0.05, 0.37, 0.47, 0.32, 0.33],
    )
    ...
    expected_result = ProblemInstance(
        items=items,
        assignments=[0, 1, 2, 0, 0, 3, 3, 4, 0, 5, 1, 4],
        free_space=[0, 0.09, 0.05, 0.01, 0.1, 0.62],
    )
    ...
    expected_result = ProblemInstance(
        items=items,
        assignments=[0, 1, 2, 3, 4, 4, 5, 3, 1, 0, 2, 2],
        free_space=[0, 0, 0.14, 0.1, 0.01, 0.62],
    )
    test_algorithm(
        test2,
        expected_result,
    ...
    expected_result = ProblemInstance(
        items=items,
        assignments=[0, 1, 2, 1, 2, 3, 3, 4, 0, 5, 0, 4],
        free_space=[0.14, 0, 0, 0.01, 0.1, 0.62],
    )
    ...
    expected_result = ProblemInstance(
        items=items,
        assignments=[0, 1, 2, 3, 4, 4, 5, 3, 1, 0, 3, 3],
        free_space=[0, 0, 0.21, 0.03, 0.01, 0.62],
    )
    test_algorithm(
        test2, expected_result, requirements.best_fit_decreasing, "best_fit_decreasing"
    )
    ...
    # next-fit
    expected_result = ProblemInstance(
        items=items, assignments=[0, 1, 1, 2, 2, 2, 3], free_space=[0.57, 0, 0.01, 0.36]
    )
    ...
    # first-fit decreasing
    expected_result = ProblemInstance(
        items=items, assignments=[0, 1, 2, 2, 3, 0, 1], free_space=[0, 0.33, 0.03, 0.58]
    )
    test_algorithm(
        test3,
        expected_result,
    ...
    # best-fit
    expected_result = ProblemInstance(
        items=items, assignments=[0, 1, 1, 0, 2, 0, 3], free_space=[0.12, 0, 0.46, 0.36]
    )
    test_algorithm(test3, expected_result, requirements.best_fit, "best_fit")

    # best-fit decreasing
    expected_result = ProblemInstance(
        items=items, assignments=[0, 1, 2, 2, 3, 0, 2], free_space=[0, 0.36, 0, 0.58]
    )
    test_algorithm(
        test3, expected_result, requirements.best_fit_decreasing, "best_fit_decreasing"
    )
    ...
    expected_result = ProblemInstance(
        items=items,
        assignments=[0, 1, 2, 3, 3, 3, 4, 5, 6, 6, 7, 8, 9, 9, 9, 9, 9, 10, 11, 11],
        free_space=[
            0.46,
            0.33,
            0.54,
    ...
    expected_result = ProblemInstance(
        items=items,
        assignments=[0, 1, 0, 2, 1, 1, 3, 4, 5, 1, 5, 6, 2, 4, 2, 6, 3, 7, 8, 3],
        free_space=[0, 0.01, 0, 0.08, 0.12, 0, 0.01, 0.37, 0.57],
    )
    ...
    expected_result = ProblemInstance(
        items=items,
        assignments=[0, 1, 2, 3, 4, 5, 6, 7, 7, 6, 5, 3, 1, 2, 4, 0, 0, 2, 0, 2],
        free_space=[0, 0.01, 0.01, 0, 0.14, 0, 0, 0],
    )
    test_algorithm(
        test4,
        expected_result,
    ...
    expected_result = ProblemInstance(
        items=items,
        assignments=[0, 1, 0, 2, 1, 1, 3, 4, 5, 1, 5, 6, 4, 6, 3, 2, 3, 7, 8, 3],
        free_space=[0, 0.01, 0.18, 0.01, 0, 0, 0.02, 0.37, 0.57],
    )
    ...
    expected_result = ProblemInstance(
        items=items,
        assignments=[0, 1, 2, 3, 4, 5, 6, 7, 7, 6, 5, 3, 1, 2, 4, 2, 4, 4, 0, 4],
        free_space=[0.13, 0.01, 0.02, 0, 0, 0, 0, 0],
    )
    test_algorithm(
        test4, expected_result, requirements.best_fit_decreasing, "best_fit_decreasing"
    )
